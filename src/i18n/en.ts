export const enLang = {
  ...
  EntrenaAppTitle: "Entrena+ Atletismo [Mobile App] [University Final Project]",
  ...
  HotelDesktopTitle: "Hotel Administrative System (Desktop App)",
  HotelDesktopDescription: "A hotel management system that efficiently handles reservations, rooms, and guests, optimizing hotel operations.",
